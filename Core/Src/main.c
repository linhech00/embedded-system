...
// {
// 	startTimer(TIME_OUT, testTimer, NULL);
// 	DisplayAxisValues();
...
int main(void)
{
  ...
  // ILI9341_WriteString(0, 0, (char*)"HELLO", Font_16x26, ILI9341_WHITE, ILI9341_GREEN);
  // startTimer(TIME_OUT, testTimer, NULL);
  /* USER CODE END 2 */
  ...
  while (1)
  {
    // HAL_UART_Transmit(&huart6, (uint8_t*)"Hello", 5, 1000);
    // HAL_Delay(1000);
		processTimerEvents();
    /* USER CODE END WHILE */
